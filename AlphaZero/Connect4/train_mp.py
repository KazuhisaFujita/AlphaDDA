...
class Train():
    def __init__(self):
        ...
        # self.net.load_checkpoint(30)

    def Make_schedule(self, num, players):
        # Set the schedule of games.
    ...
    def test(self, i):
        # Set the openings for the test.
        self.params.opening = self.params.opening_test

        devices = self.params.devices

        schedule = self.Make_schedule(self.params.num_test, ["alphazero", "mcts"])
