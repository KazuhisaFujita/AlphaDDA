...
import random
import math
from nn_dropout import NNetWrapper as nnet
...
class A_MCTS:
    ...
    def Run(self):
        ...
        if self.nn.net.dropout > 0.95:
            self.nn.net.dropout = 0.95
    ...
    def Get_prob(self):
        ...
        for i in self.root.children:
            prob[i.move[0] * self.params.board_y +  i.move[1]] += i.nsa# ** (1 / self.params.Tau)
